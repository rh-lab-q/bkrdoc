...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_automata(self):
        my = bkrdoc.StatementDataSearcher(bkrdoc.Parser("./bkrdoc_not_tagged/examples/Bashlex_modified_tests/apache-test.sh"),bkrdoc.PhaseContainer("test"))
    ...
    def test_rlRpm_commands(self):
        mys = bkrdoc.StatementDataSearcher(bkrdoc.Parser("./bkrdoc_not_tagged/examples/Bashlex_modified_tests/apache-test.sh"),bkrdoc.PhaseContainer("test"))
