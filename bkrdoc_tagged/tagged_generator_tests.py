...
class TaggedGeneratorTests(unittest.TestCase):
    ...
    def test_phases_comments(self):
        ...
        self.assertEqual(parser.phases[4].get_comments_list(), [[['#', '@', 'Print', 'help', 'informations'], ['#', '@keywords', 'doc', 'help'], ['#', 'blah', '@networking', '@action', '@wifi', 'sfsdf', 'sdf', 'sdfsd', 'f'], ['#', 'Using', 'of', 'block', 'comment'], ['#', 'This', 'could', 'be', 'usefull']]])
        ...
        self.assertEqual(parser.phases[8].get_comments_list(), [[['#@Single', 'enablned', 'as', '@try', 'a', 'argument']]])
        self.assertEqual(parser.phases[9].get_comments_list(), [])
        self.assertEqual(parser.phases[10].get_comments_list(), [[['#@', 'Disabled', 'as', 'a', 'argument']]])
