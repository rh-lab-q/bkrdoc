...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_assert_equal(self):
        ...
        sec = bkrdoc.DocumentationTranslator(bkrdoc.Parser("./examples/tests/apache-test.sh"))
    ...
    def test_rlRpm_commands(self):
        mys = bkrdoc.StatementDataSearcher(bkrdoc.Parser("./examples/tests/apache-test.sh"),bkrdoc.PhaseContainer("test"))
    ...
    def test_assert2_commands(self):
        ...
        self.assertEqual(mys.parsed_param_ref.pattern,"Not Found")
        self.assertEqual(mys.parsed_param_ref.file, "stderr")
        pokus = bkrdoc.DocumentationTranslator(bkrdoc.Parser("./examples/tests/apache-test.sh"))
